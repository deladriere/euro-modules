...
void rot()
{
                ...
                interruptCount =constrain(interruptCount,7000,9000 ); // 2 dents per unit
...
term.position(1,0);
term.print(F("Potsound  Allophone#  Allophone  Note#   Note   SampleR   Period\t"));
...

                {
                               ...
                               //Print Note number
                               voice.note=map(analogRead(POT_SPEED),0,1013,0,127);
                               term.position(2,33);
