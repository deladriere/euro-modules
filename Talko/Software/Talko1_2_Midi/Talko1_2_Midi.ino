...
// Midi version : french voyels out 
...
void checkMIDI(){
  do{
    if (Serial.available()){
      ...
      voice.velocityByte = Serial.read();//read final byte
    }
  }
...
void rot()
{
                ...
                interruptCount =constrain(interruptCount,0,36 ); // 2 dents per unit
