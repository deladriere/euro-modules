...
void get_mode()
	...
	3: Nato alphabet
	4: Vocabulary
	5: big numbers (from 0 to 9999999)
...
void vocabulary()
	...
	switch(sound)
		...
		case 1:
			voice.say(spFREQUENCY);
			break;
		case 2:
			voice.say(spTELEPHONE);
			break;
		case 3:
			voice.say(spINSTRUMENTS);
			break;
		case 4:
			voice.say(spAIRPORT);
			break;
		...
		case 6:
			...
			break;
		case 7:
			voice.say(spDEPARTURE);
			break;
		case 8:
			voice.say(spAIRCRAFT);
			break;
		case 9:
			voice.say(spCYLINDER);
			break;
		case 10:
			voice.say(spCRYSTALS);
			break;
		case 11:
			voice.say(spBOOST);
			break;
...
void loop()
	...
	switch(mode)
		...
		case 3:
			...
			nato(map(analogRead(1),0,1000,1,26));
			break;
