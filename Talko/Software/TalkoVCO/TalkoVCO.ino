...
void loop()
  ...
  if((PIND & B10000) >> 4 ) //  faster then digitalRead(LOOP)==1)
	...
	switch(mode)
		...
		case 4:
			vocabulary(map(analogRead(1),0,1023,1,62));
			break;
		...
		case 12:
			sentences(map(analogRead(1),0,1023,1,13));
			break;

		case 13:
			vowels_FR(map(analogRead(1),0,1010,1,5));
			break;

		case 14:
			sayDigitFrench(map(analogRead(1),0,1013,0,9));
			break;
