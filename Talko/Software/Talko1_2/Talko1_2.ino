...
//un
const uint8_t spW067056 [] PROGMEM = {0xA7,0x6A,0x3A,0x32,0xC4,0x5D,0x9F,0x2A,0xE7,0x36,0xF1,0x96,0x75,0xAA,0x5C,0xCB,0x4C,0xCB,0xD6,0xA9,0xF2,0x74,0x31,0x4B,0x47,0xA7,0x4A,0x4D,0xD8,0x2B,0x64,0x9F,0x3A,0x6B,0x73,0xB5,0x48,0xB5,0xEA,0x9C,0xDC,0xC0,0xBD,0x36,0x3C};
//deux
const uint8_t spW035277 [] PROGMEM = {0x00,0x30,0xC6,0x45,0x49,0x25,0x3C,0xCE,0x19,0x8E,0x54,0x17,0x53,0xDB,0x67,0x4C,0x38,0x52,0xB3,0x1B,0x9D,0xD1,0xE8,0x4E,0xBD,0xAE,0x74,0x26,0x2F,0x2A,0x74,0x26,0xD6,0x59,0xBC,0x4A,0x97,0x9D,0x8A,0x6B,0x75,0xB2,0xD2,0xB2,0x26,0xAC,0xD5,0xF1,0xEA,0x71,0xAB,0xD9,0x56,0x27,0xB3,0x32,0x6A,0xE2,0x03};
//trois
const uint8_t spW131965 [] PROGMEM = {0x05,0x90,0x3C,0xD5,0x01,0x58,0x9F,0xAE,0x7A,0x80,0x18,0x67,0x4D,0xB4,0x16,0xC7,0xBF,0xC5,0xA4,0xC9,0x58,0xB8,0xFF,0x10,0x97,0x2A,0x6B,0xE3,0xF1,0x93,0x4D,0x63,0x9F,0xDD,0xDA,0x2F,0xD2,0x88,0x72,0x8E,0x10,0xBE,0x59,0x33,0xCA,0x39,0xA2,0xDD,0x51,0xAE,0x4A,0xE7,0xC9,0xEE,0x4B,0xB9,0x26,0x9D,0xAE,0x98,0x1B,0xC7,0xAC,0xB4,0xBA,0xAA,0x7A,0x0D,0xB2,0xE4,0xE8,0xB2,0xBF,0x66,0xE9,0x40,0xA5,0xCB,0xFE,0x5B,0x24,0x0B,0xC3,0x03};
//quatre
const uint8_t spW104032 [] PROGMEM = {0x27,0x5F,0xC1,0x44,0x3C,0xE3,0x9C,0xA1,0x5A,0x53,0xCD,0x8C,0x75,0x86,0xE6,0x3C,0x82,0xD5,0xD1,0x59,0xAB,0xAF,0x30,0x55,0xCB,0x67,0x6B,0xAE,0x2D,0xC4,0xCD,0x9C,0xBD,0x19,0x77,0xB1,0xB4,0x94,0xD0,0xC2,0xC5,0x29,0x53,0x12,0x43,0x0B,0x50,0xB5,0xF0,0x44,0x08,0xED,0x44,0x44,0x44,0x6C,0x13,0x00,0xF0,0x0C,0x80,0x46,0x4E,0x1B,0x61,0xEE,0x51,0x0F,0xD9,0x6D,0x97,0xB9,0x3A,0x1D,0x78,0x73,0x57,0x19,0x29,0xB7,0xA1,0x43,0xCF,0x84,0x9A,0xA5,0x95,0x37,0xBB,0x19,0xA1,0x76,0x46,0xDE,0xEC,0x97,0x99,0x59,0x6E,0x79,0x75,0x5F,0xA6,0x26,0xFA,0x01};
//cinq
const uint8_t spW024946 [] PROGMEM = {};
//six
const uint8_t spW120832 [] PROGMEM = {0x0D,0xBD,0xB1,0x43,0xC5,0x6A,0x07,0x60,0x69,0xD7,0x00,0x4C,0x93,0x1C,0x80,0x2D,0x93,0x03,0xB0,0x74,0x68,0x02,0x8E,0x36,0x39,0xCD,0x92,0xC2,0x9C,0x33,0xF9,0x4C,0x1D,0xB3,0xC7,0x6C,0xE4,0x33,0x57,0x24,0x16,0xBB,0x91,0xCF,0x36,0x31,0xC6,0xCC,0x54,0x3E,0x7B,0x83,0x54,0xBD,0x13,0xE9,0x5C,0x93,0xA1,0x65,0x6F,0xED,0xD3,0x9D,0xAA,0x8A,0x30,0x4B,0x4E,0x77,0xEA,0x44,0x00,0xC6,0x5E,0xDD,0xCE,0x3B,0xC3,0x1C,0x6B,0x75,0x33,0xFD,0x8C,0x69,0xEC,0xD6,0xED,0xB0,0x95,0x62,0x55,0x12,0xBA,0x43,0x57,0x88,0xC7,0x4E,0xE8,0x0E,0x53,0xA9,0x1A,0x37,0xE1,0xC7,0x4D,0xB9,0x59,0xDC,0x44,0x1D,0xDF,0x15,0x6A,0x49,0x00,0x00,0x40,0x00,0x15,0x88,0xC0,0x03};
//sept
const uint8_t spW022500 [] PROGMEM = {0x8D,0xDC,0x79,0x72,0x83,0x93,0x1A,0x60,0xE9,0x54,0x03,0x6C,0x65,0x6A,0x80,0x29,0x42,0x0C,0x30,0x45,0xEA,0x29,0x8B,0x30,0xB3,0xE8,0xC8,0x67,0xAD,0xD6,0x4C,0xB3,0x6A,0x9F,0xA3,0x7A,0x0D,0xAD,0xAA,0x75,0xEA,0xA6,0xB9,0x62,0x22,0xE2,0xA9,0xBB,0x36,0xA7,0x0A,0x2B,0xA3,0x4E,0xDC,0x22,0xA6,0x42,0xAB,0xDA,0x03,0x35,0x8B,0x8C,0x4C,0xEA,0x86,0x58,0x54,0x2D,0x0E,0x90,0x3A,0x11,0xB6,0x74,0xB7,0x0D,0xF0};
//huit
const uint8_t spW066908 [] PROGMEM = {0x6B,0xAF,0x92,0x45,0xE6,0x5A,0x8D,0x23,0x4A,0xF6,0xDC,0x6A,0x38,0x76,0xAF,0xD4,0x6B,0xDB,0xE1,0xDA,0x93,0x26,0x9D,0xEE,0x96,0x67,0x6F,0x01,0xC5,0xBA,0x57,0x9E,0xBD,0x59,0x62,0xDB,0x59,0x74,0xCE,0x2E,0x58,0x78,0x6E,0xE1,0xBA,0x3A,0x65,0xD1,0xB9,0x8A,0x0A,0x00,0xEE,0x1A,0x1E};
//neuf
const uint8_t spW087098 [] PROGMEM = {0x6D,0x17,0xAA,0x7A,0xC2,0x4C,0x8D,0xD5,0x73,0x9D,0xAD,0x08,0x35,0x56,0x2B,0x74,0x3A,0xD3,0xE4,0x58,0xA4,0xB2,0xC9,0x2C,0x51,0x67,0x49,0xDC,0xCC,0xAB,0x2A,0x9F,0xAD,0x68,0x37,0xF1,0xAA,0x75,0xF6,0xAA,0x2C,0x35,0xA3,0xD2,0x39,0xB2,0x88,0xD2,0xCC,0x90,0xE7,0x4C,0x3C,0x2A,0xCC,0x63,0x9E,0xBF,0x0B,0x75,0x77,0xAD,0x75,0xFE,0x2A,0xDC,0xD4,0x7C,0x36,0x18,0xA0,0x72,0x31,0x00,0x00,0x78};
//zéro
const uint8_t spW137690 [] PROGMEM = {};
...
const uint8_t spROBOTER [] PROGMEM = {};

// french vowels

const uint8_t spA_FR[] PROGMEM = {0x00,0xb0,0x9c,0xec,0x3a,0xb9,0x42,0xf2,0x71,0x73,0x9c,0x94,0x69,0x39,0xc7,0xc9,0xb9,0x43,0x36,0x65,0x1f,0x37,0x97,0x76,0x5e,0xb3,0x73,0xbc,0x12,0xa6,0xa8,0xd3,0xf6,0xf1,0x52,0x2f,0x93,0x55,0x3b,0x27,0x48,0x33,0x45,0x57,0x14,0x8f,0x30,0xe5,0x31,0x5c,0xa1,0xd3,0xc2,0x6c,0xda,0x20,0x5d,0x4e,0x08,0x8b,0x1f,0x46,0x33,0x38,0x2e,0x2e,0xf9,0x82,0xd3,0x20,0x11,0x20,0x46,0x03,0x02,0x28,0x17,0x02,0x00,0x00,0x00,0x00,0x00,0xf0};
const uint8_t spE_FR[] PROGMEM = {0x00,0x30,0xec,0x64,0xc5,0x39,0x57,0xf2,0x71,0x52,0x64,0xf1,0x5c,0x3b,0xc7,0x4d,0xca,0xd4,0x65,0x23,0x1f,0x2f,0x4b,0x33,0x97,0x09,0x7d,0xbc,0x64,0xd4,0x25,0xd6,0xf2,0xf1,0x93,0x55,0xb1,0xd8,0xd0,0x2b,0x48,0x4e,0x55,0xe2,0x4c,0x8f,0x30,0x1a,0x35,0x8d,0xb3,0x3c,0x92,0x68,0x4c,0x3d,0xce,0x74,0x4b,0xbc,0x53,0xcb,0x5a,0xd1,0x21,0xe5,0xde,0x32,0xbb,0xc1,0xa8,0x0c,0x25,0x8b,0xa9,0x02,0xcd,0x52,0x61,0xc5,0x7d,0x47,0x34,0x00,0x00,0x00,0x00,0x00,0x00,0x3c};
const uint8_t spI_FR[] PROGMEM = {0x00,0x10,0x4c,0x8f,0xb3,0xaf,0xd0,0x72,0x73,0x33,0x50,0xbf,0x45,0x47,0xc3,0x6b,0x40,0x64,0x4e,0x6d,0x0f,0xaf,0x42,0x96,0x7d,0x95,0x3c,0xfc,0x82,0x59,0x7f,0x59,0x72,0x0b,0x32,0x62,0xfb,0x25,0xc9,0x23,0xcc,0x48,0xfc,0x97,0x25,0xb7,0x38,0x01,0x8d,0x5f,0x96,0x54,0x92,0x00,0xa3,0xbe,0xc9,0x54,0x4a,0x03,0xd2,0xfc,0xd4,0x88,0x26,0x25,0x2c,0xeb,0xc2,0x23,0x89,0x9c,0xf1,0xac,0xf1,0x28,0xc9,0x0a,0x47,0x38,0x27,0x62,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x3c};
const uint8_t spO_FR[] PROGMEM = {0x00,0x04,0x20,0x33,0x25,0x05,0xaa,0x34,0x69,0x54,0x95,0x16,0xa8,0x32,0xa4,0x5e,0x51,0x4b,0x20,0x5b,0xa3,0x66,0x45,0x2e,0x81,0x68,0x4d,0x92,0x55,0x39,0x05,0xac,0x2d,0x73,0x64,0x94,0x10,0xd2,0xd5,0xac,0x51,0x51,0x5c,0xc2,0x9f,0x62,0x4c,0xd8,0x76,0x09,0x9b,0x85,0xea,0x99,0x44,0x64,0x70,0x8f,0xb0,0x7b,0x6c,0x91,0x82,0x5e,0x6c,0xe1,0x89,0x59,0x2a,0x93,0xbb,0x8a,0xd8,0x21,0x25,0xf3,0xe6,0xae,0x16,0x19,0x00,0x00,0x00,0x00,0x00,0x00,0x1e};
const uint8_t spU_FR[] PROGMEM = {0x00,0xd0,0xcc,0x2c,0x58,0xa6,0x2b,0xf0,0x31,0x9b,0x22,0xea,0xea,0x51,0xc7,0x6c,0x8a,0xb0,0xab,0x47,0x1d,0xb3,0x4a,0xc2,0xea,0xaa,0x7c,0xec,0x66,0x08,0x33,0xa7,0xcc,0xb1,0x9b,0x21,0xcc,0x9c,0x22,0xcb,0xae,0x8a,0xb0,0xaa,0x8b,0x0c,0x27,0x0b,0xd4,0xcd,0x0a,0x33,0xdc,0x22,0x51,0xbb,0x36,0x4c,0x71,0x03,0x67,0xff,0x0e,0xb3,0xc1,0x13,0xd2,0xea,0x53,0xc5,0x1a,0x0f,0xeb,0xd8,0x15,0x13,0xcb,0x7c,0xa4,0x6d,0x37,0xc3,0x2e,0xf1,0xb5,0xa4,0x9a,0x2e,0x3b,0x00,0x00,0x00,0x00,0x00,0x00,0xf0};
...
void voltmeter()
	{
	int voltage = analogRead(POT_SOUND) * 5.000 / 1.023;
	sayNumber(voltage);
	voice.say(spM_MILLI);
	voice.say(spM_VOLTS);
	}
...
void frequencemeter()
	{
	int hertz = analogRead(POT_SOUND) * 5.000 / 1.023;
	sayNumber(hertz);
	voice.say(spM_HERTZ);
	}
...
void alphabet()
	{
	int letter= map(analogRead(POT_SOUND),0,1023,1,26);
...
//delay(5);
	...
	interruptCount =constrain(interruptCount,0,28); // 2 dents per unit

	bank = interruptCount/2; // 2 dents per unit 
...
void digits()
	{
	int n = map(analogRead(POT_SOUND),0,1000,0,9);
	sayNumber(n);
	}

void sentences(int s)
	{
...
void counter()
	...
	reset = analogRead(POT_SOUND);// normal= A0
...
void digitsF()
	{
	int n = map(analogRead(POT_SOUND),0,1023,0,9);
	sayNumberF(n);
	}

void bigNumbers()
	{
	long n = map(analogRead(POT_SOUND),0,1023,0,999);
	sayNumber(n);
	}
  ...
  if(mode==MODE_SPEECH) // 1 = VCO  ; 2= SPEECH ; 3= REPEAT
	...
	switch(bank)
		...
		case 3:
			...
			nato(map(analogRead(POT_SOUND),0,1000,1,26));
			break;

		case 4:
			vocabulary(map(analogRead(POT_SOUND),0,1023,1,62));
			break;
		...
		case 11:
			vocabulary(random(62));
			break;

		case 12:
			sentences(map(analogRead(POT_SOUND),0,1023,1,13));
			break;

		case 13:
			vowels_FR(map(analogRead(POT_SOUND),0,1010,1,5));
			break;

		case 14:
			sayDigitFrench(map(analogRead(POT_SOUND),0,1013,0,9));
			break;
